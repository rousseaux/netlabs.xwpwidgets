...
/*
 *@@sourcefile w_rmonitor.h:
 *      private header file for the REXX monitor widget.
 ...
 */
    ...
    // REXX monitor settings dialog ids
    #define ID_CRD_RMONITOR_SETTINGS       1000
    #define ID_CRDI_RMONITOR_SCRIPT        1001
    #define ID_CRDI_RMONITOR_DBLCLK        1002
    #define ID_CRDI_RMONITOR_REFRESH       1003
    #define ID_CRDI_RMONITOR_TITLE         1004
    #define ID_CRDI_RMONITOR_RESIZEABLE    1008
    #define ID_CRDI_RMONITOR_FIXEDWIDTH    1009
    #define ID_CRDI_RMONITOR_WIDTH         1010
    #define DID_APPLY                      1011
    #define DID_RESET                      1012
    #define ID_CRDI_RMONITOR_STATUS        1013
    #define ID_CRDI_RMONITOR_STATUS2       1014

    #define ID_CRH_RMONITOR_SETTINGS       1000
    #define ID_CRH_RMONITOR_MAIN           1001
    #define ID_CRH_RMONITOR_DBLCLKERROR1   1002
    #define ID_CRH_RMONITOR_DBLCLKERROR2   1003
    #define ID_CRH_RMONITOR_TIMERERROR     1004
